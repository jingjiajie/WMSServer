...
public class DeliveryOrderItemView {
    ...
    @Basic
    @Column(name = "DeliveryOrderItemCreatTime")
    public Timestamp getDeliveryOrderItemCreatTime() {
        return deliveryOrderItemCreatTime;
    }

    public void setDeliveryOrderItemCreatTime(Timestamp deliveryOrderItemCreatTime) {
