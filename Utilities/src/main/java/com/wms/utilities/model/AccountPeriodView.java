...
public class AccountPeriodView {
    ...
    private String lastAccountPeriodName;
    ...
    @Basic
    @Column(name = "LastAccountPeriodName")
    public String getLastAccountPeriodName() {
        return lastAccountPeriodName;
    }

    public void setLastAccountPeriodName(String lastAccountPeriodName) {
        this.lastAccountPeriodName = lastAccountPeriodName;
    }
    ...
    public boolean equals(Object object) {
        ...
        AccountPeriodView that = (AccountPeriodView) object;
        ...
        if (warehouseName != null ? !warehouseName.equals(that.warehouseName) : that.warehouseName != null)
            return false;
        if (lastAccountPeriodName != null ? !lastAccountPeriodName.equals(that.lastAccountPeriodName) : that.lastAccountPeriodName != null)
            return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (lastAccountPeriodName != null ? lastAccountPeriodName.hashCode() : 0);
        return result;
    }
}
